...
public class TrainService {
    ...
    public TrainService() throws IOException {
        String trainFilePath = "src/main/java/ticket/booking/localDB/trains.json";
        File trains = new File(trainFilePath);
    ...
    private void saveTrainListToFile() {
        try {
            String trainFilePath = "src/main/java/ticket/booking/localDB/trains.json";
            objectMapper.writeValue(new File(trainFilePath), trainList);
        } catch (IOException e) {
